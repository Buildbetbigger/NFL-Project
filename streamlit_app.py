            ...
            try:
                ...
                if config['use_genetic']:
                    ...
                    for r in results:
                        ...
                        flex_sal = sum(df.loc[df['Player'] == p, 'Salary'].iloc[0] for p in r['flex'] if
                    ...
                    max_possible_salary = df['Salary'].max() * OptimizerConfig.CAPTAIN_MULTIPLIER + df[
                        'Salary'].nlargest(5).sum()
