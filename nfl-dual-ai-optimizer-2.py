...
st.title('🏈 NFL Showdown Optimizer - API Enhanced')
...
# For Google Colab testing
if 'google.colab' in str(get_ipython()) if 'get_ipython' in dir() else False:
    st.info("Running in Google Colab - Make sure to install requirements: !pip install streamlit pandas pulp scipy matplotlib seaborn anthropic")
...
**API Mode:**
1. Enter your Claude API key (get from console.anthropic.com)
2. Click "Test API Connection"
3. Upload CSV and configure settings
...
!pip install streamlit pandas pulp scipy matplotlib seaborn anthropic

# Save this script as app.py, then run:
!streamlit run app.py
```

API costs approximately $0.01 per optimization run.
""")

st.caption("NFL Optimizer v3.0 - API Enhanced | Powered by Claude AI")